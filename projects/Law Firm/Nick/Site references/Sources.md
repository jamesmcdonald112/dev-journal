...
## Hero
- Don't want any staff in it
- Don't want american style
- Court house (check if we can use it.)
...
- Personal Litigation
- Family law
- Extra areas (dont push as much) use a see more option for this - check images on whatapp)
- Images for each area (stock images probably)
...
- email
- phone
- dropdown to select area of law
- brief description
- General note - no automatic phone button
- dont put the email on the page, only use contact form
